...
class ComidasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comida" do
    assert_difference("Comida.count") do
      post comidas_url, params: { comida: { compra: @comida.compra, desc: @comida.desc, estragado: @comida.estragado, nome: @comida.nome, price: @comida.price, quantidade: @comida.quantidade, vencimento: @comida.vencimento } }
    end
  ...
  test "should update comida" do
    patch comida_url(@comida), params: { comida: { compra: @comida.compra, desc: @comida.desc, estragado: @comida.estragado, nome: @comida.nome, price: @comida.price, quantidade: @comida.quantidade, vencimento: @comida.vencimento } }
